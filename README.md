...
**Dự án Tốt nghiệp — Khóa học Data Analysis from Zero to Hero**
...
1. **Danh mục sản phẩm nào tạo ra nhiều doanh thu nhất?** Thương hiệu có đang phụ thuộc quá nhiều vào một vài danh mục không?
2. **Giá sản phẩm có nhất quán trên các nền tảng không?** Sự chênh lệch giá ảnh hưởng như thế nào đến niềm tin của khách hàng?
3. **Danh mục nào đang có nguy cơ hết hàng?** Rủi ro tồn kho ảnh hưởng như thế nào đến doanh thu mùa cao điểm?
4. **Xu hướng địa lý nào đang nổi bật?** Đâu là thị trường tiềm năng để tăng đầu tư marketing?

---

## Nguồn dữ liệu

- **Nguồn:** Dữ liệu nội bộ thực tế của công ty (real working data)
- **File:** `Master_File.xlsx` — một file Excel chứa 6 sheet dữ liệu
- **Lưu ý bảo mật:** Dữ liệu được sử dụng cho mục đích học thuật; tên khách hàng và thông tin nhận dạng cá nhân không được chia sẻ công khai
...
```
/
├── Master_File.xlsx                  # Dữ liệu gốc
├── README.md                         # File này
├── Final_Report_VI.docx              # Báo cáo cuối cùng (tiếng Việt)
├── Presentation_VI.pptx              # Slide thuyết trình (tiếng Việt)
├── Fashion_Ecommerce_Analysis.pbix   # File Power BI (data model + dashboard)
└── charts/                           # Biểu đồ xuất từ Python/Power BI
    ├── chart1_category.png           # Doanh thu theo danh mục
    ├── chart2_monthly.png            # Xu hướng doanh thu theo tháng
    ├── chart3_platform.png           # So sánh giá MRP theo nền tảng
    ├── chart4_inventory.png          # Phân tích rủi ro tồn kho
    ├── chart5_states.png             # Top 8 tiểu bang theo doanh thu
    └── chart6_pies.png               # Tỷ lệ kênh bán và danh mục
```
